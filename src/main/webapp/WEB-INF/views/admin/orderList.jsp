			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.yuyongsong.model.Order o=(com.yuyongsong.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.yuyongsong.dao.UserDao userDao=new com.yuyongsong.dao.UserDao();
						...
						<%
							...
							String paymentType=com.yuyongsong.model.Payment.findByPaymentId(con,n);
							 %>
